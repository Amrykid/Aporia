...
##
## .. code-block:: Nimrod
##    loadCfgLocaleData(LocaleManager, r"C:\Users\Alex\Documents\Random\LocaleData.cfg") #Loads a config file with the localized strings.
##    echo(LocaleManager.getKey("Greeting")) #Prints the localized string for the user's locale.
##    echo(LocaleManager.getKeyLang("Greeting","de")) #Prints the localized string in the specified locale.
##
##
## Example CFG file
## .. code-block
...
when isMainModule:
    ...
    echo(LocaleManager.getKey("Greeting"))
    echo(LocaleManager.getKeyLang("Greeting","de"))